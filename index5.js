var index = 0;
var audio = new Audio("Songs4/song1.mp3");
var allSongs = ["song1.mp3", "song2.mp3", "song3.mp3", "song4.mp3", "song5.mp3"]

var SongsName = {
  music: ["Closer- The Chainsmokers", "Shape of You", "See You Again", "Treat You Better", "Just the Way You Are"]
}
...
document.getElementById("forw").addEventListener('click', () => {
  ...
  if (index > 5) {
    index = 0;
    audio.src = ("Songs4/" + allSongs[index]);
    audio.play();
  } else {
    audio.src = ("Songs4/" + allSongs[index]);
    audio.play();
