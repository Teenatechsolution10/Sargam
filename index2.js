var index = 0;
var audio = new Audio("Songs1/song1.mp3");
var allSongs = ["song1.mp3", "song2.mp3", "song3.mp3", "song4.mp3", "song5.mp3"]

var SongsName = {
  music: ["Tum Se Hi-Jab We Met", "Kaise Hua - Kabir Singh", "Soch Na Sake- Airlift", "Ae Watan Watan- Raazi", "Ye Ratein Ye Mausam- Sanam"]
}
...
document.getElementById("forw").addEventListener('click', () => {
  ...
  if (index > 5) {
    index = 0;
    audio.src = ("Songs1/" + allSongs[index]);
    audio.play();
  } else {
    audio.src = ("Songs1/" + allSongs[index]);
    audio.play();
